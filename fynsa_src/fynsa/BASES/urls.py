...
urlpatterns = [
    ...
    path('comite/salida/montos-mensual-clientes/<str:selectorProductoMonto>/<int:selectorAgnoMonto>', views.monto_mensual_cliente, name='monto_mensual_cliente'),
    path('comite/salida/generacion-mensual-clientes/<str:selectorProductoGen>/<int:selectorAgnoGen>', views.gen_mensual_cliente, name='gen_mensual_cliente'),

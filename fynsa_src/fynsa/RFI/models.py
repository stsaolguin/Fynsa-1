...
class bonos_rfi(models.Model):
    ...
    bb_composite = models.CharField(max_length=4,default='NR')
    payment_rank = models.CharField(max_length=40)
    cntry_of_risk = models.CharField(max_length=2,null=True,blank=True)
    yas_mod_dur = models.DecimalField(max_digits=5, decimal_places=3,default=0,null=True,blank=True)
    yas_bond_yld = models.DecimalField(max_digits=5, decimal_places=3,default=0,null=True,blank=True)
